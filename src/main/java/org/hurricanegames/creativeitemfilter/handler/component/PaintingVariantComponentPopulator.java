...
public class PaintingVariantComponentPopulator implements ItemComponentPopulator {
	...
	public void populateComponents(@NotNull ItemStack oldItem, @NotNull ItemStack newItem,
		...
		if(oldItem.getType() != Material.PAINTING) {
			return;
		}

		ItemComponentUtils.copyComponent(oldItem, newItem, DataComponentTypes.PAINTING_VARIANT);
	}
}
